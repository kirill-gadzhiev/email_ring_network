...
class MacPackager extends _platformPackager().PlatformPackager {
  ...
  sign(appPath, outDir, masOptions) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      if (masOptions != null && !isDevelopment) {
        ...
        yield _this3.dispatchArtifactCreated(artifactPath, null, _builderUtil().Arch.x64, _this3.computeSafeArtifactName(artifactName, "pkg"));
      }
    })();
  }
  ...
  applyCommonInfo(appPlist, contentsPath) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      if (_this5.platformSpecificBuildOptions.darkModeSupport) {
